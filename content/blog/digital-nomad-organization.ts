...
export const metadata: BlogFrontmatter = {
  ...
  excerpt: "As a digital nomad, keeping track of multiple trips can be overwhelming. Here's how TripCache helps you stay organized while working remotely.",
  description: "As a digital nomad, keeping track of multiple trips can be overwhelming. Here's how TripCache helps you stay organized while working remotely.",
  date: "2024-12-28",
...
export const body = String.raw`# Organization Tips for Digital Nomads Using TripCache
