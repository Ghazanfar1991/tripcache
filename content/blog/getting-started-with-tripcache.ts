...
export const metadata: BlogFrontmatter = {
  ...
  excerpt: "Learn how to set up TripCache and start organizing your travel itineraries in minutes. From email forwarding to CSV exports, we cover everything you need to know.",
  description: "Learn how to set up TripCache and start organizing your travel itineraries in minutes. From email forwarding to CSV exports, we cover everything you need to know.",
  date: "2025-01-15",
  ...
  keywords: [
    ...
    "travel itinerary setup",
    "trip management guide"
  ],
}

export const body = String.raw`# Getting Started with TripCache
