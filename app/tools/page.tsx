...
export default function ToolsIndexPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f4f0e8] pt-28 text-[#29251f] [font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,'Segoe_UI',sans-serif]">
      ...
      <SectionContainer className="relative pb-20 pt-8 lg:pb-28 lg:pt-12">
        <div className="grid items-end gap-8 min-[850px]:grid-cols-[minmax(0,1.15fr)_minmax(20rem,0.65fr)] min-[850px]:gap-16">
          <div><p className="inline-flex w-fit rounded-full bg-white/55 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.16em] text-[#a44833] shadow-[inset_0_0_0_1px_rgba(58,48,38,0.08),0_8px_28px_rgba(72,53,33,0.05)]">Travel tools</p>
          <h1 className="design-one-display-index mt-6">Practical tools for refundable bookings</h1></div>
          <p className="max-w-3xl text-lg leading-8 text-[#696158]">
        ...
        <div className="mt-12 max-w-3xl min-[850px]:ms-auto min-[850px]:mt-14">
          <Link
            ...
            className="group block rounded-[2rem] bg-[#29251f] p-7 text-[#f7f2e9] shadow-[0_30px_70px_rgba(59,43,27,0.18)] transition-transform duration-150 hover:-translate-y-1 sm:p-10"
          >
            <div className="grid h-12 w-12 place-items-center rounded-2xl bg-[#db6947] text-white"><CalendarClock className="h-5 w-5" /></div>
            ...
            <span className="mt-8 inline-flex items-center gap-2 text-sm font-semibold text-[#e98362]">
              Open calculator
