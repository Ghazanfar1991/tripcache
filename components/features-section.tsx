...
const features = [
  {
    ...
    description:
      "Forward booking emails and TripCache turns confirmations into organized trip drafts.",
    images: ["/app-screenshot-import.webp", "/app-screenshot-drafts.webp"],
    imageAlts: [
      "TripCache email import screen for booking confirmations",
      "TripCache draft itinerary review screen",
    ],
  ...
  },
  {
    ...
    description:
      "Keep flights, hotels, rental cars, transport, activities, tickets, restaurants, parking, notes, and custom items in one trip.",
    images: ["/app-feature-add-everything.webp"],
    imageAlts: [
      "TripCache screen for adding flights hotels rental cars tickets notes and custom trip items",
    ],
  ...
  },
  {
    ...
    description:
      "Save free-cancellation deadlines and get reminded before hotels, cars, tours, or tickets become non-refundable.",
    images: ["/app-feature-cancellation-reminder.webp"],
    imageAlts: [
      "TripCache free cancellation reminder screen for refundable travel bookings",
    ],
  ...
  },
  {
    ...
    description:
      "Store passports, boarding passes, tickets, visas, and confirmations with PIN-protected access.",
    images: ["/app-feature-secure-documents.webp"],
    imageAlts: [
      "TripCache secure travel document vault for passports boarding passes tickets and visas",
    ],
  ...
  },
  {
    ...
    description:
      "Stay on top of every journey with flight status, live progress, and your travel details in one view.",
    images: ["/app-screenshot-flight-detail.webp"],
    imageAlts: [
      "TripCache live flight tracking screen with status and travel details",
    ],
  ...
  },
  {
    ...
    title: "Trip Map View",
    description:
      "Visualize your destination, stays, activities, and travel context on a map built for trip days.",
    images: ["/app-screen-trip-map.webp"],
    imageAlts: [
      "TripCache trip map screen showing destinations stays and activities",
    ],
  ...
  },
  {
    ...
    description:
      "Track trip costs, save receipts, and keep cleaner records for reimbursement or personal budgets.",
    images: ["/app-screen-expense-management.webp"],
    imageAlts: [
      "TripCache expense management screen for receipts costs and travel budgets",
    ],
  ...
  },
  {
    ...
    title: "Smart Exports",
    description:
      "Generate detailed CSV reports for tax records, reimbursements, and travel reviews.",
  ...
  return (
    <div className="relative mx-auto mt-24 hidden h-[400px] w-full max-w-5xl overflow-hidden md:block">
      ...
      {mobileScreens.map((screen, index) => {
        ...
        const finalX = offsetIndex * 110;
        const finalRotate = offsetIndex * 6;
        const finalY = Math.abs(offsetIndex) * 15;
        ...
        return (
          <div
            ...
            style={{
              transform: `translateX(calc(-50% + ${finalX}px)) translateY(${finalY}px) rotate(${finalRotate}deg) scale(${scale})`,
              zIndex,
            }}
          >
...
export function FeaturesSection() {
  return (
    <section
      id="features"
      className="tripcache-section-backdrop relative overflow-hidden bg-background py-12 dark:bg-slate-950 sm:py-20"
    >
      ...
      <SectionContainer className="relative z-10">
        <div className="mb-20 text-center max-w-4xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 rounded-full border border-border/70 bg-background/70 px-4 py-2 text-sm font-semibold uppercase tracking-wide text-primary shadow-lg shadow-primary/5 backdrop-blur-md dark:border-white/10 dark:bg-white/5 dark:text-cyan-400">
            <Zap className="w-4 h-4" />
            <span>Everything You Need</span>
          </div>

          <h2 className="mb-6 text-5xl font-extrabold tracking-tight text-foreground dark:text-white md:text-6xl">
            Powerfully Simple.
            <br />
          ...
          <p className="text-xl text-muted-foreground dark:text-slate-300">
            Master every booking in your itinerary, from flights and stays to
            maps, expenses, cancellation deadlines, and secure documents.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-700 pointer-events-none`}
              />
              ...
              <div className="relative w-full h-56 mt-6 px-6 overflow-hidden flex justify-center items-end">
                ...
                <div
                  className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 rounded-full bg-gradient-to-r ${feature.gradient} blur-[60px] opacity-20 group-hover:opacity-60 transition-opacity duration-700`}
                />
              ...
              <div className="relative z-10 mt-auto bg-gradient-to-t from-background via-background/85 to-transparent p-8 pt-6 dark:from-slate-900 dark:via-slate-900/80">
                ...
                <div
                  className={`h-1 w-0 bg-gradient-to-r ${feature.gradient} rounded-full mt-6 transition-all duration-500 group-hover:w-full opacity-50`}
                />
              </div>
            </div>
          ))}
        ...
        <div className="mt-32 text-center hidden md:block">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-border/70 bg-background/70 px-6 py-2 text-xs font-bold uppercase tracking-[0.3em] text-primary shadow-xl backdrop-blur-md dark:border-white/10 dark:bg-white/5 dark:text-cyan-400">
            The Complete Picture
          </div>
          <h3 className="mb-4 text-3xl font-bold text-foreground dark:text-white">
