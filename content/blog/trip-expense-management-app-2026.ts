...
export const metadata: BlogFrontmatter = {
  ...
  keywords: [
    "trip expense management app",
    "travel expense management app",
    "travel receipt organizer",
    "trip cost tracker",
    "travel reimbursement app",
    "TripCache expense management",
  ],
}

export const body = String.raw`# Trip Expense Management App: Track Travel Costs, Receipts, and Reimbursements
...
Add reminders for refundable hotels, cars, tours, and tickets. See our [free cancellation reminder guide](/blog/free-cancellation-reminder-travel-bookings-2026) and [hotel cancellation reminder guide](/blog/hotel-cancellation-reminder-app-2026).
