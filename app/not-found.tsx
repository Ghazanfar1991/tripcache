    ...
    <main className="journal-paper min-h-screen text-[#121212]">
      <section className="flex min-h-[78svh] items-center px-5 pb-20 pt-32 sm:px-8 sm:pt-36">
        <div className="mx-auto w-full max-w-[900px] rounded-[36px] bg-white/50 p-8 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.8),0_28px_75px_rgba(72,53,33,0.08)] sm:p-14">
          <div className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-[#e8e0ff] text-[#4d20af]">
            <Compass className="h-6 w-6" aria-hidden="true" />
          </div>
          <p className="mt-7 text-[11px] font-bold uppercase tracking-[0.18em] text-[#4d20af]">404 · Route not found</p>
          ...
          <p className="mx-auto mt-6 max-w-xl text-base leading-7 text-[#666666] sm:text-lg">
            The address may have changed, or the page may no longer be available. Head home to keep exploring TripCache.
          </p>
          <Link
            href="/"
            className="design-one-press mt-8 inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[#121212] px-6 text-sm font-semibold text-[#f7f2e9] transition-colors hover:bg-[#242424] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4d20af]/55 focus-visible:ring-offset-2 focus-visible:ring-offset-[#f4f0e8]"
          >
