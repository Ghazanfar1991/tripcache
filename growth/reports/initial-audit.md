...
The authenticated App Store Connect Sales and Trends API reports 12 first-time downloads, three redownloads, and eight updates for the latest complete 28-day period, July 19 through August 15. The dashboard independently reported 12 App Units from July 16 through August 15, down 33% from the preceding comparison period, with 92% on iPhone and 8.3% on iPad. The automated and manual snapshots remain separate so unlike periods are never presented as equivalent. A dedicated Sales and Reports team key is active and the daily collector has passed its live test.
...
3. Let Google Play's newly granted bulk-report permission propagate. App Store collection is active; Crashlytics export is enabled and awaiting its first daily tables.
